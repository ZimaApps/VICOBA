...
public class createCase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText vog = findViewById(R.id.creatorphone);
        vog.setText(userNumber);
    ...
    public void createcase(){
        TextInputEditText kikobaname = findViewById(R.id.kikobaname);
        String kikobanamex = kikobaname.getText().toString();
        TextInputEditText creatorname = findViewById(R.id.creatorname);
        String creatornamex = creatorname.getText().toString();
        TextInputEditText creatorphone = findViewById(R.id.creatorphone);
        String creatorphonex = creatorphone.getText().toString();
        TextInputEditText password = findViewById(R.id.creatorpassword);
                ...
                if(creatorphonex == ""){
                    ...
                    if(passwordx == "" || passwordx.length() < 4){
                        ...
                        try{
                            ...
                            userId = generateRandomStringByUUID().replace("-", "");
                            kikobaId = generateRandomStringByUUID().replace("-", "");
    ...
    private class UploadImagetoserverY extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() {
            ...
            String FILE_UPLOAD_URLXX = "http://zimaapps.com/mobileApps/vicoba/createNewKikoba.php";
            ...
            try {
                ...
                if (statusCode == 200) {
                    ...
                    createCase.this.runOnUiThread(new Runnable() {
                        public void run() {
                            createdialog("KUNA TATIZO LA MTADAO","Tafadhali jaribu tena. Kama tatizo litaendelea, piga namba 0754 244 888 kutujulisha kuhusu hili tatizo");
    ...
    public void createdialog(String thetitle, String themeseji){
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(createCase.this).create(); // Read
        // Update
